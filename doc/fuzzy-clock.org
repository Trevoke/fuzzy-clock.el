...
* First Contact: What is This and Why Should You Care?
...
* The Black Triangle: Your First Fuzzy Clock in 30 Seconds
...
* The Hairball: Understanding Fuzzy Time
...
Fuzzy Clock gives you 9 different resolutions. Let's understand them from the inside out.
...
#+begin_src emacs-lisp
(setq fuzzy-clock-fuzziness 'week)
#+end_src

Your mode-line shows: "Week 42", "Week 1", etc. (ISO week numbers)

At this level, you're thinking in terms of *project timelines*. Individual days blur together. What matters is which week of the year you're in.

*When to use this:* When you're planning long-term projects. When you think in sprints or weekly cycles.
...
** Level 9: Season (Maximum Fuzziness)

#+begin_src emacs-lisp
(setq fuzzy-clock-fuzziness 'season)
#+end_src

Your mode-line shows: "Winter", "Spring", "Summer", or "Fall"

This is the most abstract level. Time has been reduced to its most basic cycle: the seasons.
...
*When to use this:* Probably never in your mode-line. But it's useful conceptually. It reminds you that time is cyclical, not linear. We're always in one of four states, rotating forever.
...
7. Week — Subdividing months/years
8. Month — Subdividing years
9. Season — Subdividing years

Levels 1-4 are about *precision within a day*.
Levels 5-9 are about *position within larger cycles*.
...
- Planning your week? → Use ~day-of-week~ or ~week~
- Just want to stay grounded in the current season? → Use ~season~
...
But if your fuzziness is ~season~, updating every 60 seconds is overkill. Seasons last three months. You could update once a day:
...
- ~week~ → 86400 seconds (24 hours)
- ~month~ → 86400 seconds (24 hours)
- ~season~ → 86400 seconds (24 hours)
...
* The Reference: Complete Technical Documentation
...
70+ acceptance tests ensure correctness.
